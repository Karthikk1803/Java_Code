        ...
        while(true) {
            ...
            for (Employee e : fil) {
                ...
                if (f.equals("age") || f.equals("id")) {
                    ...
                    switch (op) {
                        case "equals":
                            if (fieldVal.equals(val)) newlist.add(e);
                            break;
                        case "not_equals":
                            if (!fieldVal.equals(val)) newlist.add(e);
                            break;
                        case "contains":
                            if (fieldVal.contains(val)) newlist.add(e);
                            break;
                        case "not_contains":
                            if (!fieldVal.contains(val)) newlist.add(e);
                            break;
                        case "start":
                            if (fieldVal.startsWith(val)) newlist.add(e);
                            break;
                        case "ends":
                            if (fieldVal.endsWith(val)) newlist.add(e);
                            break;
                        default:
            ...
            System.out.println("1. Add Conditions\n2.Update\n3.Exit\n");
            int c = sc.nextInt();
                    ...
                    for (Employee e : fil) {
                        if(e.id == id){
                            switch(inp){
                                ...
                                case "age": e.age = Integer.parseInt(val); break;
                                case "department": e.department = val; break;
                                case "designation": e.designation = val; break;
                                case "reporting": e.reporting = val; break;
                            }
                            break;
                        }
                    }
